...
// Expects multipart/form-data with files: m15, h1, h4 (required), calendar (optional),
// and optional text field "instrument".
...
function getFilePath(file: any) {
  return file?.filepath || file?.path || undefined; // formidable v3 vs v2
}
...
export default async function handler(
  ...
  try {
    ...
    const meta = {
      ...
      warningWindow: false, // we'll add programmatic calendar warning later
    };
