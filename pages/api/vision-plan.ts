...
"- Regime Bonus: +20pts in trending markets, -10pts in ranging markets",
    ...
    "",
  "ENHANCED TOURNAMENT SCORING (0-100 each strategy):",
"1. Analyze current setup against each strategy's criteria (Base: 0-70pts)",
"2. Apply ML pattern recognition adjustment (±15pts based on historical data)",
"3. Market regime multiplier: Current volatility/trend strength (×0.8-1.3)",
"4. Performance feedback: Recent strategy success rate (±10pts)",
"5. Fundamental alignment bonus/penalty (±15pts)",
"6. Confidence interval: Calculate uncertainty range for each score",
"7. Option 1 = Highest scoring with >15pt margin, Option 2 = Strong alternative",
"",
"MACHINE LEARNING INTEGRATION (ai_meta required):",
"• pattern_confidence: [0-100] - ML confidence in pattern recognition",
"• historical_analogs: [number] - Similar setups found in training data",
"• success_probability: [0-1] - Estimated probability based on historical performance",
"• volatility_adjusted_score: [0-100] - Score adjusted for current market conditions",
"• regime_alignment: [optimal/good/poor/avoid] - Strategy fit for current regime",
"• learning_weight: [0-1] - How much weight to give this outcome for future learning",
    "",
...
"• Flag if recommending position would exceed portfolio heat limits",
"• Warn about currency concentration risk (multiple USD positions)",
"• Alert if news events could affect multiple open positions simultaneously",
"• Calculate maximum adverse excursion based on historical volatility",
    "",
    "RISK-REWARD VALIDATION:",
    "- Minimum R:R ratio: 1.5:1 for any trade recommendation",
    "- Optimal R:R ratio: 2:1 to 3:1 for institutional quality",
    "- If R:R < 1.5:1, recommend 'SETUP INVALID - Poor risk-reward'",
    "- Calculate exact R:R: (TP1 - Entry) ÷ (Entry - SL)",
    "",
    "CORRELATION CHECKS:",
   ...
   "TRADE QUALITY FILTERS - INSTITUTIONAL STANDARDS:",
    ...
    "2. STRUCTURE CONFLUENCE: Entry must have 2+ confirming factors:",
    "   - Structure level + BOS, or Round number + Session level, or Support/Resistance + Order block",
    "3. CLEAR INVALIDATION: Must identify specific price where setup becomes wrong",
    "4. REASONABLE STOP DISTANCE: 15-80 pips normal mode, 8-25 pips scalping mode",
    "",
...
"",
"CLIENT TIMEZONE DETECTION (JavaScript handles DST automatically):",
"- Use new Date() for current user local time",
"- Convert to major financial center times using Intl.DateTimeFormat",
"- London: Europe/London timezone (GMT/BST automatic)",
"- New York: America/New_York timezone (EST/EDT automatic)",
"- Tokyo: Asia/Tokyo timezone (JST - no DST)",
"- Sydney: Australia/Sydney timezone (AEST/AEDT automatic)",
"",
"SESSION ACTIVITY WINDOWS (converted to user's local time):",
"- Tokyo Session: 21:00 Sun - 06:00 Mon JST (Asian liquidity)",
"- London Session: 08:00 - 17:00 GMT/BST (European liquidity)",
"- New York Session: 08:00 - 17:00 EST/EDT (US liquidity)",
"- Major Overlap: London+NY simultaneous (highest liquidity period)",
"",
"CURRENT SESSION DETECTION REQUIRED:",
"• User Local Time: [Display current time in user's timezone]",
"• Active Financial Centers: [List which major sessions are currently open]",
"• Liquidity Rating: [Thin/Normal/Deep] based on session overlaps",
"• Volatility Expectation: [Low/Normal/High] based on active sessions",
"• Optimal Pairs: [Suggest currency pairs most active in current session]",
"",
...
"- Stop loss: 12-20 pips (accounts for 2-3 pip spread + 2 pip slippage + 8-15 pip structure buffer).",
