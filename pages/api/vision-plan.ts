...
warn !== null ? `\nCALENDAR WARNING: High-impact event within ~${warn} min. Avoid impulsive market entries right before release.` : "",
    ...
    "",
  "MARKET CONTEXT ANALYSIS - DYNAMIC TIMEZONE DETECTION:",
"",
"CURRENT TIME DETECTION (Server-side calculation):",
"- System will calculate current UTC time and major session overlaps",
"- London Session: 7:00-16:00 UTC (GMT) / 8:00-17:00 UTC (BST summer)",
"- New York Session: 12:00-21:00 UTC (EST) / 13:00-22:00 UTC (EDT summer)", 
"- Tokyo Session: 23:00-08:00 UTC (JST - no DST changes)",
"- Sydney Session: 21:00-06:00 UTC (varies with Australian DST)",
"",
"SESSION IDENTIFICATION LOGIC:",
"- Calculate current UTC hour: new Date().getUTCHours()",
"- London Active: UTC 7-16 (winter) or 8-17 (summer) - detect via timezone offset",
"- NY Active: UTC 12-21 (winter) or 13-22 (summer) - detect via timezone offset",
"- Major Overlap: London+NY simultaneously active (highest liquidity)",
"- Thin Liquidity: Outside major sessions or during holidays",
"",
"DYNAMIC SESSION DETECTION OUTPUT REQUIRED:",
"• Current UTC Time: [HH:MM] UTC",
"• Active Sessions: [Tokyo/London/NY/Sydney] with liquidity rating",
"• Major Overlaps: [None/London-NY/Asia-London] with timing window",
