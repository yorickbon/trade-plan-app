...
"- Look at last 3-5 major swing highs (peaks) from left to right across visible chart",
"- Look at last 3-5 major swing lows (troughs) from left to right across visible chart",
...
"- CRITICAL: Counter-trend bounce in downtrend ≠ bullish trend",
