...
"",
"ENHANCED CHART READING PROTOCOL:",
"- Focus on price scale on RIGHT edge of chart",
"- Current price = rightmost candle's close level",
"- BITCOIN CRITICAL PROTOCOL:",
"  * Bitcoin charts show prices like 109.3K meaning 109,300",
"  * If reading 109.2 or 109.3, actual price is 109,200 or 109,300", 
"  * MULTIPLY any 3-digit Bitcoin reading by 1000 (109 → 109,000)",
"  * Bitcoin currentPrice must be 50,000-150,000 range typically",
"  * If you read under 1,000 for Bitcoin, you misread the scale",
"- FX PAIRS: Read literal decimals (0.65300, 1.0845)",
"- INDICES: Read full numbers (18,345.67 for NAS100)",
"- Trace horizontal from rightmost close to right price axis",
"- Report this EXACT number in ai_meta.currentPrice",
"- If Bitcoin scale unclear, report 'BITCOIN_SCALE_UNCLEAR'",
"- DEBUG: Always describe what you see on the right price axis",
"- For TradingView: Current price often in colored box on right axis",
"",
