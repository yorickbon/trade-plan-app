...
function systemCore(
 ...
 "RISK MANAGEMENT - INSTITUTIONAL STANDARDS:",
    ...
    "1. Account Risk Per Trade: 1-2% of account maximum",
  ...
  warn !== null ? `\nCALENDAR WARNING: High-impact event within ~${warn} min. Avoid impulsive market entries right before release.` : "",
    ...
    "",
    "MARKET CONTEXT ANALYSIS - INSTITUTIONAL TIMING:",
    "",
    "SESSION TIMING CONSIDERATIONS:",
    "- London Open (3:00-5:00 AM EST): High volatility, breakouts common",
    "- NY Open (9:30-11:00 AM EST): Major moves, institutional flow",
    "- Asian Session (7:00 PM - 3:00 AM EST): Lower volatility, range-bound",
    "- Session Overlaps: London/NY (8:00-12:00 EST) = highest liquidity",
    "- Current time analysis: Identify which session and adjust strategy accordingly",
    "",
    "LIQUIDITY CONDITIONS:",
    "- Major holidays: Avoid trading on US/UK/EU bank holidays",
    "- Friday afternoons: Reduced liquidity after 12:00 EST",
    "- Economic news blackouts: 30 min before/after high-impact events",
    "- Thin market warning: Asian session for EUR/GBP pairs",
    "",
    "VOLATILITY REGIME ANALYSIS:",
    "- High volatility: Widen stops, reduce position size",
    "- Low volatility: Tighten stops, potential breakout setups",
    "- Volatility expansion: Post-news, session opens",
    "- Volatility contraction: Pre-news, session endings",
    "",
    "INSTITUTIONAL LEVELS:",
    "- Round numbers: 1.2000, 1.2500, etc. (psychological levels)",
    "- Weekly/Monthly opens: Institutional reference points",  
    "- Previous day high/low: Key intraday levels",
    "- Session highs/lows: London high, NY high, Asian range",
    "",
    ...
    "• Session Status: [London/NY/Asian] + liquidity assessment",
    "• Volatility Regime: [High/Normal/Low] + implications",
    "• Key Institutional Levels: [List 2-3 nearest round numbers/session levels]",
    "• Timing Recommendation: [Ideal/Acceptable/Avoid] for entry timing",
    "",
...
"Full Breakdown",
   ...
   "Detected Structures (X-ray):",
    "IMPORTANT: Describe what you ACTUALLY SEE in each chart, not theoretical patterns.",
    "Format: [Trend] → [Current location] → [Recent BOS if any] → [Key observation]",
    "Examples: 'Uptrend → At highs → Recent BOS down → Losing momentum' or 'Downtrend → Mid-range → Recent BOS up → Potential reversal'",
    "Example: 'Uptrend → At recent highs → Testing prior resistance now turned support'",
