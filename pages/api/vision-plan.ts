...
warn !== null ? `\nCALENDAR WARNING: High-impact event within ~${warn} min. Avoid impulsive market entries right before release.` : "",
    ...
    "",
    "MARKET CONTEXT ANALYSIS - INSTITUTIONAL TIMING (AUTO DST):",
    "",
    "SESSION TIMING CONSIDERATIONS (Times adjust automatically for CET/CEST):",
    "- Asian Session: 1:00-9:00 AM local (Low volatility, range-bound)",
    "- London Open: 9:00-11:00 AM local (High volatility, European breakouts)", 
    "- London/NY Overlap: 2:00-6:00 PM local (Maximum liquidity, major moves)",
    "- NY Session: 3:30-10:00 PM local (US data, institutional flows)",
    "- Weekend: Saturday 11:00 PM - Sunday 11:00 PM local (Markets closed)",
    "",
