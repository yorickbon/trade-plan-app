...
"Evaluate the current setup and provide two distinct trading approaches:",
"",
"Option 1 (Primary): Best setup based on current market conditions",
"Option 2 (Alternative): Secondary setup or opposing view for risk management",
"",
...
"Rate the overall setup quality on multiple factors:",
"• Structure clarity: How obvious are the key levels?",
"• Timeframe alignment: Do multiple timeframes agree?", 
"• Risk-reward potential: Is the R:R attractive?",
"• Fundamental backing: Do fundamentals support the technical view?",
"• Execution timing: Is this optimal entry timing?",
"",
