...
/* =========================================================================
   PIXEL-BASED CHART SWING EXTRACTOR (drop-in, no hard dep)
   - Reads candles from pixels (black/white charts), builds RAW SWING MAP.
   - Safe on Vercel: soft-requires 'jimp'; if missing, it auto-skips.
   ========================================================================= */
