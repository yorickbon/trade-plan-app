...
"PROFESSIONAL VALIDATIONS - SANITY CHECKS:",
  ...
  "INSTITUTIONAL FORMAT STANDARDS:",
    ...
    "",
    "INVALIDATION CRITERIA (Specific price levels):",
    "• Long Trade Invalidation: 'Setup invalid if price closes below [specific price]'",
    "• Short Trade Invalidation: 'Setup invalid if price closes above [specific price]'",
    "• Time-based Invalidation: 'Reassess if no movement within [X] hours'",
    "",
