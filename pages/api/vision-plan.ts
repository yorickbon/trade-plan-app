...
"",
   "MANDATORY CHART ANALYSIS PROTOCOL - PROFESSIONAL STRUCTURE READING:",
    ...
    "",
   "Step 5: STRUCTURE ANALYSIS (Enhanced)",
"- Check TradingView BOS indicator if available",
"- Recent BOS UP/DOWN/NONE and when",
"- Validate against your swing analysis",
"- IDENTIFY SPECIFIC STRUCTURE LEVELS:",
"  * Recent swing high: [exact price] at [location on chart]",
"  * Recent swing low: [exact price] at [location on chart]", 
"  * Key support level: [price] (tested X times)",
"  * Key resistance level: [price] (tested X times)",
"  * Order blocks: [price range] from [timeframe context]",
"- Current price relative to these specific levels",
"- NEVER use round numbers unless they align with actual structure",
    "",
