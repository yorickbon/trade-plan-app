...
"- Look at last 3-5 major swing highs (peaks) - these should be the MOST RECENT ones",
"- Look at last 3-5 major swing lows (troughs) - these should be the MOST RECENT ones",
"- State exact prices: 'Swing highs: 0.6900 → 0.6850 → 0.6800 = descending'",
...
"• Maximum Loss: State pip distance and approximate dollar impact",
   ...
   "5. Base conviction: Conv = (0.50 × T) + (0.35 × F) + (0.15 × R) + alignment",
    ...
    "   - B-grade: Conv × 0.90 (10% reduction)",
    "   - C-grade: Conv × 0.75 (25% reduction)",
    "   - D-grade: Cap at 45 maximum regardless of calculation",
    "8. Final: Round to whole number, clamp between 0-100",
    "",
    "EXAMPLE:",
