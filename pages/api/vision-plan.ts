...
"'⚠️ This is a lower-probability setup. Consider waiting for [specific better condition].'",
   ...
   "OUTPUT format (in this exact order):",
    ...
    "**1H Analysis:**",
    "• Independent trend: [UPTREND/DOWNTREND/RANGE]",
    "• Swing highs: [list exact prices]",
    "• Swing lows: [list exact prices]",
    "• Relationship to 4H: [CONFIRMS/CONFLICTS/CONSOLIDATES]",
    ...
    "",
    "**Strategy Tournament Results:**",
    "• Structure Break & Retest: [score]/100 - [reason]",
    "• Order Block Reaction: [score]/100 - [reason]",
    "• Reversal at Extremes: [score]/100 - [reason]",
    "• Liquidity Grab: [score]/100 - [reason]",
