...
"- Entry zones reflect structure width, not arbitrary ranges",
    ...
    "",
 "STRATEGY TOURNAMENT - PROFESSIONAL HEDGE FUND APPROACH:",
    "Run 5 institutional strategies in parallel, score each, select top 2 for Option 1 and Option 2.",
    "",
    ...
    "- Score factors: Clear BOS visible (30pts), Clean retest setup (25pts), Good R:R >2:1 (20pts), HTF alignment (25pts)",
    "",
    ...
    "1. Analyze current setup against each strategy's criteria",
    "2. Award points based on how well setup matches strategy requirements", 
    "3. Apply fundamental alignment bonus/penalty (±15 pts)",
    "4. Rank strategies by total score",
    "5. Option 1 = Highest scoring strategy, Option 2 = Second highest",
    "",
